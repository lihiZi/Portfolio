...
class Layout extends Component {
    ...
    return(
       ...
       <Skills/>
        ...
        <Project hrf="https://salty-bayou-23682.herokuapp.com/" img={require("../../Assets/computer.png")} location="18/2/21/5" newLocation="20/2/23/12">OutDoorz is a social app in the making. It aims to connect camping lovers. built with: Node.js, HTML5, CSS3, JavavScript, MongoDB, Bootstrap, npm Packages,and git. Deployed on Heroku servers.</Project>
        <Project hrf="https://salty-cliffs-48595.herokuapp.com/index.html" img={require("../../Assets/Project2.png")} location="18/6/21/9" newLocation="24/2/27/12">A responsive and mobile-friendly company website template, built with: HTML5, CSS3, JavavScript, Bootstrap, and git. Deployed on Heroku servers.</Project>
        <Project hrf="" img={require("../../Assets/Project3.png")} location="18/10/21/13" newLocation="28/2/31/12">A responsive website that was built for a health tech company. It was made with vanila JavavScript, HTML and CSS, using Grid-css system. </Project>
