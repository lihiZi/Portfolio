...
class Layout extends Component {
    ...
    return(
        <div className={classes.layout}>
            ...
            <Skills/>
            <Project
                hrf="https://salty-bayou-23682.herokuapp.com/" target="_blank"
                img={require("../../Assets/computer.png")}
                location="18/2/21/5" newLocation="20/1/23/3" >
            ...
            <Project
                hrf="https://salty-cliffs-48595.herokuapp.com/index.html" target="_blank"
           ...
           <Project
                ...
                A responsive website that was built for a health tech company. It was made with vanila JavavScript,
                HTML and CSS, using Grid-css system.
            </Project>
