...
class Layout extends Component {
    ...
    return(
       ...
       <Skills/>
        ...
        <Project hrf="" img={require("../../Assets/Project3.png")} target="_blank" location="18/10/21/13" newLocation="28/2/31/12">A responsive website that was built for a health tech company. It was made with vanila JavavScript, HTML and CSS, using Grid-css system. </Project>
